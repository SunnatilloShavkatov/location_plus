...
public class LocationPlugin implements FlutterPlugin, ActivityAware {
    ...
    private void initialize(FlutterLocationService service) {
        ...
        activityBinding.addActivityResultListener(Objects.requireNonNull(locationService.getLocationActivityResultListener()));
        activityBinding.addRequestPermissionsResultListener(Objects.requireNonNull(locationService.getLocationRequestPermissionsResultListener()));
        activityBinding.addRequestPermissionsResultListener(locationService.getServiceRequestPermissionsResultListener());
        assert methodCallHandler != null;
        methodCallHandler.setLocation(locationService.getLocation());
        methodCallHandler.setLocationService(locationService);
        assert streamHandlerImpl != null;
    ...
    private void dispose() {
        ...
        activityBinding.removeRequestPermissionsResultListener(Objects.requireNonNull(locationService.getLocationRequestPermissionsResultListener()));
        activityBinding.removeActivityResultListener(Objects.requireNonNull(locationService.getLocationActivityResultListener()));
